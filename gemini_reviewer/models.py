...
class ReviewComment:
    ...
    def to_github_comment(self) -> dict[str, Any]:
        ...
        return {"body": self.body, "path": self.path, "position": self.position}
...
class AnalysisContext:
    ...
    full_file_content: str | None = None  # Full content of the file being reviewed
    all_changed_files: list[str] = field(default_factory=list)  # All files changed in PR
    change_summary: str | None = None  # Summary of all changes in PR
